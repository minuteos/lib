...
PROJECT_SOURCE_DIR = $(call relcanon,$(PROJECT_ROOT)src/)
...
SOURCE_DIRS = $(sort $(SOURCE_DIR) $(call subdirs,$(SOURCE_DIR),$(SOURCE_NESTED_DIRS)) $(TARGET_DIRS) $(COMPONENT_DIRS))
...
RM = $(POSIX_PREFIX)rm
MKDIR = $(POSIX_PREFIX)mkdir
ECHO = $(POSIX_PREFIX)echo
CAT = cat
DATE = date
TEE = tee
LN = ln
